...
ASSUMPTIONS = [
    ...
    "介護保険の自己負担割合が1割か2割か3割かの判定に使う年金収入は、"
    "老齢年金だけとしています。遺族年金と障害年金は非課税なので"
    "合計所得金額には入りませんが、介護保険料の段階の判定には"
    "入る自治体があります。ここでは扱っていません",
    ...
    "実際に引いて出しています。この節だけは、上に置いた手取り率の仮定"
    "（年額78万円で100パーセント、500万円で79パーセントなど）を使っていません",
