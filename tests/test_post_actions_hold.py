...
`src/uploader._post_actions` は**1本の投稿ごとに 100単位**を使います
（`playlistItems.insert` 50 ＋ `commentThreads.insert` 50。`playlists.insert` の
50 は再生リストを作る回だけ）。実測 08/27 の窓は 37本 ＝ 約 **3,700単位**、
残してある `RESERVE_UNITS` 400 の **9.3倍**を、
