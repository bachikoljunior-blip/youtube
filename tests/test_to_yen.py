...
CASES: list[tuple[str, set[int]]] = [
    ...
    # **表の行。空白で区切った列を1つの数として食わないこと。**
    # `300万` と `450,000円` は別の列。つなげて 3,450,000 にすると、
    # **450,000 が二度と拾われず、許可する数の集合が黙って縮む。**
    ("     300万    450,000円    55,644円   114,000円  2,380,356円",
     {3000000, 450000, 55644, 114000, 2380356}),
    ("   620万      630万     71,864円    71.9%", {6200000, 6300000, 71864}),
